...
class ModuleConfig_MapReportSettings extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set shouldReportLocation($core.bool v) { $_setBool(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasShouldReportLocation() => $_has(2);
  @$pb.TagNumber(3)
  void clearShouldReportLocation() => clearField(3);
}
...
class ModuleConfig_NeighborInfoConfig extends $pb.GeneratedMessage {
  factory ModuleConfig_NeighborInfoConfig({
    ...
    if (transmitOverLora != null) {
      $result.transmitOverLora = transmitOverLora;
    }
    return $result;
  }
  ...
  @$pb.TagNumber(3)
  set transmitOverLora($core.bool v) { $_setBool(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasTransmitOverLora() => $_has(2);
  @$pb.TagNumber(3)
  void clearTransmitOverLora() => clearField(3);
}
...
class ModuleConfig_DetectionSensorConfig extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(7)
  set detectionTriggerType(ModuleConfig_DetectionSensorConfig_TriggerType v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasDetectionTriggerType() => $_has(6);
  @$pb.TagNumber(7)
  void clearDetectionTriggerType() => clearField(7);
...
class ModuleConfig_PaxcounterConfig extends $pb.GeneratedMessage {
  factory ModuleConfig_PaxcounterConfig({
    ...
    if (wifiThreshold != null) {
      $result.wifiThreshold = wifiThreshold;
    }
    if (bleThreshold != null) {
      $result.bleThreshold = bleThreshold;
    }
    return $result;
  }
  ...
  @$pb.TagNumber(3)
  set wifiThreshold($core.int v) { $_setSignedInt32(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasWifiThreshold() => $_has(2);
  @$pb.TagNumber(3)
  void clearWifiThreshold() => clearField(3);
  ...
  @$pb.TagNumber(4)
  set bleThreshold($core.int v) { $_setSignedInt32(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasBleThreshold() => $_has(3);
  @$pb.TagNumber(4)
  void clearBleThreshold() => clearField(4);
}
...
class ModuleConfig_StoreForwardConfig extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(6)
  set isServer($core.bool v) { $_setBool(5, v); }
  @$pb.TagNumber(6)
  $core.bool hasIsServer() => $_has(5);
  @$pb.TagNumber(6)
  void clearIsServer() => clearField(6);
}
...
class ModuleConfig_RangeTestConfig extends $pb.GeneratedMessage {
  factory ModuleConfig_RangeTestConfig({
    ...
    if (clearOnReboot != null) {
      $result.clearOnReboot = clearOnReboot;
    }
    return $result;
  }
  ...
  @$pb.TagNumber(4)
  set clearOnReboot($core.bool v) { $_setBool(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasClearOnReboot() => $_has(3);
  @$pb.TagNumber(4)
  void clearClearOnReboot() => clearField(4);
}
...
class ModuleConfig_TelemetryConfig extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(11)
  set healthMeasurementEnabled($core.bool v) { $_setBool(10, v); }
  @$pb.TagNumber(11)
  $core.bool hasHealthMeasurementEnabled() => $_has(10);
  @$pb.TagNumber(11)
  void clearHealthMeasurementEnabled() => clearField(11);
  ...
  @$pb.TagNumber(12)
  set healthUpdateInterval($core.int v) { $_setUnsignedInt32(11, v); }
  @$pb.TagNumber(12)
  $core.bool hasHealthUpdateInterval() => $_has(11);
  @$pb.TagNumber(12)
  void clearHealthUpdateInterval() => clearField(12);
  ...
  @$pb.TagNumber(13)
  set healthScreenEnabled($core.bool v) { $_setBool(12, v); }
  @$pb.TagNumber(13)
  $core.bool hasHealthScreenEnabled() => $_has(12);
  @$pb.TagNumber(13)
  void clearHealthScreenEnabled() => clearField(13);
  ...
  @$pb.TagNumber(14)
  set deviceTelemetryEnabled($core.bool v) { $_setBool(13, v); }
  @$pb.TagNumber(14)
  $core.bool hasDeviceTelemetryEnabled() => $_has(13);
  @$pb.TagNumber(14)
  void clearDeviceTelemetryEnabled() => clearField(14);
}
