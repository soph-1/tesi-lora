...
class ServiceEnvelope extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ServiceEnvelope', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ..aOM<$7.MeshPacket>(1, _omitFieldNames ? '' : 'packet', subBuilder: $7.MeshPacket.create)
  ...
  @$pb.TagNumber(1)
  $7.MeshPacket get packet => $_getN(0);
  @$pb.TagNumber(1)
  set packet($7.MeshPacket v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasPacket() => $_has(0);
  @$pb.TagNumber(1)
  void clearPacket() => clearField(1);
  @$pb.TagNumber(1)
  $7.MeshPacket ensurePacket() => $_ensure(0);
...
class MapReport extends $pb.GeneratedMessage {
  factory MapReport({
    ...
    $2.Config_LoRaConfig_RegionCode? region,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MapReport', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ...
    ..e<$2.Config_DeviceConfig_Role>(3, _omitFieldNames ? '' : 'role', $pb.PbFieldType.OE, defaultOrMaker: $2.Config_DeviceConfig_Role.CLIENT, valueOf: $2.Config_DeviceConfig_Role.valueOf, enumValues: $2.Config_DeviceConfig_Role.values)
    ...
    ..e<$2.Config_LoRaConfig_RegionCode>(6, _omitFieldNames ? '' : 'region', $pb.PbFieldType.OE, defaultOrMaker: $2.Config_LoRaConfig_RegionCode.UNSET, valueOf: $2.Config_LoRaConfig_RegionCode.valueOf, enumValues: $2.Config_LoRaConfig_RegionCode.values)
    ..e<$2.Config_LoRaConfig_ModemPreset>(7, _omitFieldNames ? '' : 'modemPreset', $pb.PbFieldType.OE, defaultOrMaker: $2.Config_LoRaConfig_ModemPreset.LONG_FAST, valueOf: $2.Config_LoRaConfig_ModemPreset.valueOf, enumValues: $2.Config_LoRaConfig_ModemPreset.values)
  ...
  @$pb.TagNumber(3)
  $2.Config_DeviceConfig_Role get role => $_getN(2);
  @$pb.TagNumber(3)
  set role($2.Config_DeviceConfig_Role v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(6)
  $2.Config_LoRaConfig_RegionCode get region => $_getN(5);
  @$pb.TagNumber(6)
  set region($2.Config_LoRaConfig_RegionCode v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  $2.Config_LoRaConfig_ModemPreset get modemPreset => $_getN(6);
  @$pb.TagNumber(7)
  set modemPreset($2.Config_LoRaConfig_ModemPreset v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(14)
  set hasOptedReportLocation($core.bool v) { $_setBool(13, v); }
  @$pb.TagNumber(14)
  $core.bool hasHasOptedReportLocation() => $_has(13);
  @$pb.TagNumber(14)
  void clearHasOptedReportLocation() => clearField(14);
}
