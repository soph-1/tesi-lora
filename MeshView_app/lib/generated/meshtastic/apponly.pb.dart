...
class ChannelSet extends $pb.GeneratedMessage {
  factory ChannelSet({
    $core.Iterable<$4.ChannelSettings>? settings,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ChannelSet', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ..pc<$4.ChannelSettings>(1, _omitFieldNames ? '' : 'settings', $pb.PbFieldType.PM, subBuilder: $4.ChannelSettings.create)
    ..aOM<$2.Config_LoRaConfig>(2, _omitFieldNames ? '' : 'loraConfig', subBuilder: $2.Config_LoRaConfig.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$4.ChannelSettings> get settings => $_getList(0);

  ///
  ///  LoRa config
  @$pb.TagNumber(2)
  $2.Config_LoRaConfig get loraConfig => $_getN(1);
  @$pb.TagNumber(2)
  set loraConfig($2.Config_LoRaConfig v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasLoraConfig() => $_has(1);
  @$pb.TagNumber(2)
  void clearLoraConfig() => clearField(2);
  @$pb.TagNumber(2)
  $2.Config_LoRaConfig ensureLoraConfig() => $_ensure(1);
}
